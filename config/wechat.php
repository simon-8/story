...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx38ca7ee25dfb1680'),         // AppID
    'secret'  => env('WECHAT_SECRET', '75010bb5c0a059bc91591f6a11c65663'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'simon'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'MHLU35QqW9lVtInNfs1nwYaRlkalJk7h650Q0KNuGHH'),                    // EncodingAESKey
